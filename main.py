...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","Fine_N_Ok")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","villain_Il")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","fine_n_ok")
BOT_NAME = os.environ.get("BOT_NAME","SANIYA")
START_IMG = os.environ.get("START_IMG","https://files.catbox.moe/quulet.jpg")
...
SOURCE = 'https://t.me/ITsExclusive69'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
